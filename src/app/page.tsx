        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
            <PricingCard 
              title="الأساسية"
              price="مجاناً"
              features={["مستخدم واحد", "قائمة مراقبة واحدة", "رسوم بيانية أساسية", "بيانات نهاية اليوم", "أخبار السوق"]}
              cta="سجل الآن"
              href="/register"
            />
            <PricingCard 
              ...
              price="٩٩ ريال / شهر"
              features={["إمكانية إضافة حتى 3 مستخدمين", "قوائم مراقبة غير محدودة", "فلاتر متقدمة", "حفظ قوالب الرسم البياني", "تصدير البيانات", "تنبيهات لا محدودة"]}
              cta="اشترك في Pro"
              href="/subscriptions"
              highlighted={true}
            />
            <PricingCard 
              title="النخبة (Elite)"
              price="٢٤٩ ريال / شهر"
              features={["حسابات متعددة حتى 8 مستخدمين", "جميع ميزات Pro", "تحليل الذكاء الاصطناعي", "اختبار الاستراتيجيات (Backtesting)", "تقارير PDF مخصصة"]}
              cta="اشترك في Elite"
              href="/subscriptions"
            />
          </div>
